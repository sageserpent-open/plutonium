...
class WorldSpecUsingWorldReferenceImplementation
  ...
  implicit override val generatorDrivenConfig: PropertyCheckConfiguration =
    PropertyCheckConfig(maxSize = 40, minSuccessful = 20)
    ...
    check(Prop.forAllNoShrink(testCaseGenerator) {
      case (worldReferenceImplementationResource,
        ...
        val checks = for {
          ...
          (worldReferenceImplementationResults == redisBasedImplementationResults) :| s"Should have agreement between reference implementation and Redis based implementation."
        }
