...
lazy val settings = Seq(
  ...
  libraryDependencies += "net.bytebuddy"  % "byte-buddy"     % "1.18.10",
  ...
  libraryDependencies += "org.slf4j"  % "slf4j-api" % "2.0.18" % "provided",
  libraryDependencies += "com.sageserpent" %% "americium-junit5" % "2.2.1" % "test",
  libraryDependencies += "com.sageserpent" %% "americium-utilities" % "2.2.1" % "test",
