...
lazy val settings = Seq(
  ...
  libraryDependencies += "com.h2database" % "h2" % "2.3.230", // Versions >= 2.1.214 break the tests for `BlobStorageOnH2`.
  ...
  libraryDependencies += "com.sageserpent" %% "americium-utilities" % "2.1.0" % "test",
